        ...
        <div class="sidebar bg-success" id="side_nav" style="height: 100vh; width:250px;";>
            ...
            <ul class="list-unstyled px-2">
                <li class=""><a href="index.php" class="text-decoration-none px-3 py-2 d-block text-white"><i class="fal fa-list"></i>
                        Dashboard</a></li>
                <li class=""><a href="dashboard.php" class="text-decoration-none px-3 py-2 d-block text-white"  style="background-color: green; border-radius: 20px;"><i class="fal fa-list"></i>
                        Products</a></li>
                ...
                <div class="w-75 mt-5 overflow-auto" style="max-height: 400px; height: 400px;">
                    <table class="table w-100 text-center">
                        ...
                        <tbody>
                            ...
                            $no = 1;
                            $product = new Product;
                            foreach ($product -> showAll() as $tampil) {
                            ?>
                            <tr>
                                <td><?= $no ?></td>
                                <td> <img src="../asset/<?= $tampil['gambar'] ?>" width="80px" alt="" srcset=""> </td>
                                <td><?= $tampil['name'] ?></td>
                                <td><?= $tampil['price'] ?></td>
                                <td><?= $tampil['stock'] ?></td>
                                <td><?= $tampil['itemCode'] ?></td>
                                <td class="text-center"><a href="edit.php?id=<?= $tampil['id'] ?>"><button class="btn btn-primary">Edit</button></a>
                                    <a href="hapus.php?id=<?= $tampil['id'] ?>"><button onclick="return confirm('Apakah anda yakin ingin menghapus?');" class="btn btn-danger">Delete</button></a>
                                </td>
                            </tr>
                            <?php
                            $no++;
