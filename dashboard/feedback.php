        ...
        <div class="sidebar bg-success" id="side_nav" style="height: 100vh; width:250px;";>
            ...
            <ul class="list-unstyled px-2">
                ...
                <li class=""><a href="customer.php" class="text-white text-decoration-none px-3 py-2 d-block" ><i class="fal fa-users"></i>
                        Customers</a></li>
                <li class=""><a href="feedback.php" class="text-white text-decoration-none px-3 py-2 d-block" style="background-color: green; border-radius: 20px;"><i class="fal fa-users"></i>
                        Feedback</a></li>
            </ul>
                        ...
                        <table class="table w-100 text-center">
                            ...
                            <tbody>
                                ...
                                foreach ($user->showAll() as $tampil) {
                                    $name = $tampil['fname'] . " " . $tampil['lname'];
                                ?>
                                <tr>
                                    <td><?= $no ?></td>
                                    <td><?= $name ?></td>
                                    ...
                                    <td class="text-center">
                                        <a href="hapus2.php?id=<?= $tampil['id'] ?>"><button onclick="return confirm('Apakah anda yakin ingin menghapus?');" class="btn btn-danger">Delete</button></a>
                                    </td>
                                </tr>
                                <?php
                                $no++;
